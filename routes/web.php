...
Route::get("/homepage", function () {
    return "<h1>This is home homepage</h1>";
});
Route::get("/page1", function () {
    return "<h1>This is home page1</h1>";
});
Route::get("/page2", function () {
    return "<h1>This is home page2</h1>";
});
...
Route::get("/SB Admin 2 - Tables/component", function () {
    return view("SB Admin 2 - Tables-component");
});
...
Route::get("/book", [BookController::class, "index"])->name('book.index');
Route::get("/book/index2", [BookController::class, "index"])->name('book.index2');
